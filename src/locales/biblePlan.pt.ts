...
export const PLAN_PT: Mes[] = [
  {
    mes: 1,
    label: 'Mês I',
    nome: 'Novo Testamento, Parte I',
    subtitulo: 'Os Evangelhos e Atos, comece aqui',
    desc: 'A tradição recomenda começar pelos Evangelhos. A sequência sugerida é São João, São Marcos, São Lucas, Atos e São Mateus, do mais teológico ao mais histórico.',
    caps_total: 117,
    dias: 30,
    featured: true,
    grupos: [
      {
        ...
        livros: [
          { nome: 'Evangelho de São João', abrev: 'Jo', caps: 21 },
          { nome: 'Evangelho de São Marcos', abrev: 'Mc', caps: 16 },
          { nome: 'Evangelho de São Lucas', abrev: 'Lc', caps: 24 },
          { nome: 'Atos dos Apóstolos', abrev: 'At', caps: 28 },
          { nome: 'Evangelho de São Mateus', abrev: 'Mt', caps: 28 },
        ],
      },
    ],
  },
...
export const TOTAL_CAPS = PLAN_PT.reduce((s, m) => s + m.caps_total, 0)
